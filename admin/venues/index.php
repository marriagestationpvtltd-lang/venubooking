...
$db = getDB();
$stmt = $db->query("SELECT v.*, c.name AS city_name FROM venues v LEFT JOIN cities c ON v.city_id = c.id ORDER BY v.name");
                ...
                <tbody>
                    <?php foreach ($venues as $venue): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($venue['city_name'] ?? '—'); ?></td>
                            ...
                            <td>
                                <a href="view.php?id=<?php echo $venue['id']; ?>" class="btn btn-sm btn-info" title="View"><i class="fas fa-eye"></i></a>
                                <a href="edit.php?id=<?php echo $venue['id']; ?>" class="btn btn-sm btn-warning" title="Edit"><i class="fas fa-edit"></i></a>
