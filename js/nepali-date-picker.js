...
(function() {
    ...
    // Source: Official Nepali Rashtriya Panchanga (GoN) — matches the PHP server-side table exactly.
    ...
    // Reference: 1943-04-16 AD = Baisakh 1, 2000 BS
    // This matches the PHP server-side reference exactly, so JS and PHP produce
    // identical BS dates for every AD date and eliminate calendar/server mismatches.
    // Verified against official Nepali Rashtriya Panchanga:
    // - 2024-04-13 AD = 1 Baisakh 2081 BS ✓ (Nepali New Year 2081)
    // - 2025-04-13 AD = 1 Baisakh 2082 BS ✓ (Nepali New Year 2082)
    // - 2026-01-16 AD = 2 Magh 2082 BS ✓
    const referenceAD = { year: 1943, month: 4, day: 16 };
    ...
    const FALLBACK_BS_DATE = { year: 2082, month: 1, day: 1 };
