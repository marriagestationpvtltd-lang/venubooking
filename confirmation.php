    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                $wa_text .= "Program Date: " . date('F d, Y', strtotime($booking['event_date'])) . "\n";
                $wa_text .= "Event Type: " . strip_tags($booking['event_type']) . "\n\n";
                $wa_text .= "🏛️ *Venue Details*\n";
                $wa_text .= "Venue Name: " . strip_tags($booking['venue_name']) . "\n";
                $wa_text .= "Venue Location: " . strip_tags($booking['location']) . "\n";
                if (!empty($booking['map_link'])) {
                    $wa_text .= "Google Map: " . strip_tags($booking['map_link']) . "\n";
                }
                if (!empty($vendors)) {
                    $wa_text .= "\n👥 *Assigned Vendors*\n";
                    foreach ($vendors as $vendor) {
                        $wa_text .= strip_tags(ucfirst($vendor['vendor_type'])) . " Name: " . strip_tags($vendor['vendor_name']) . "\n";
                        if (!empty($vendor['vendor_phone'])) {
                            $wa_text .= strip_tags(ucfirst($vendor['vendor_type'])) . " Phone: " . strip_tags($vendor['vendor_phone']) . "\n";
                        }
                    }
                }
                ...
                <div class="text-center">
                    ...
                    <a href="<?php echo htmlspecialchars($whatsapp_url, ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener noreferrer" class="btn btn-success btn-lg me-2">
