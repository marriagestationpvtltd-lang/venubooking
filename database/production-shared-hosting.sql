...
INSERT IGNORE INTO booking_services (booking_id, service_id, service_name, price, description, category) VALUES
...
SELECT COUNT(*) as 'Total Service Categories' FROM service_categories;
SELECT COUNT(*) as 'Total Service Packages' FROM service_packages;
