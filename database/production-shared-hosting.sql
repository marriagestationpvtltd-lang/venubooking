...
CREATE TABLE IF NOT EXISTS venues (
    ...
    city_id INT NULL,
    address TEXT,
    bank_details TEXT DEFAULT NULL COMMENT 'Bank account details for venue provider payment',
    qr_code VARCHAR(255) DEFAULT NULL COMMENT 'QR code image filename for venue provider payment scanning',
    description TEXT,
    image VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS vendors (
    ...
    notes TEXT,
    bank_details TEXT DEFAULT NULL COMMENT 'Bank account details for vendor payment',
    qr_code VARCHAR(255) DEFAULT NULL COMMENT 'QR code image filename for vendor payment scanning',
